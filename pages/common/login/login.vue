	...
	<view class="container">
		...
		<form :report-submit="true" @submit="formLogin">
			<view class="tui-login-from">
				...
				<button class="tui-button-primary tui-btn-register" hover-class="tui-button-hover" @tap="register">注册</button>
...
export default {
	...
	methods: {
		...
		formLogin: function(e) {
			...
			this.tui.request("/auth/login", "POST", postData, false,true,false).then((res) => {
				res = res.data;	
				if(res.eruptUser == null){
					this.tui.toast(res.reason, 2000, false);
					return;
				}
				let state = {
					eruptUser: res.eruptUser,
					token: res.token,
